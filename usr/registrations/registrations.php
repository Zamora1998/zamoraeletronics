...
$pageTitle = $labels['navRegistrations'];
?>
    ...
    <div class="p-4 align-items-center rounded-3 border shadow-lg">
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-Registrations-tab" data-bs-toggle="tab" data-bs-target="#nav-Registrations" type="button" role="tab" aria-controls="nav-Registrations" aria-selected="true"><?= $labels['navRegistrations'] ?></button>
            </div>
        </nav>
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane  fade show active" id="nav-Registrations" role="tabpanel" aria-labelledby="nav-Registrations-tab" tabindex="0">
                <div class="row mt-2">
                    <div class="col-12">
                        <table id="tableRegistrations" class="table table-hover dataTable table-striped w-full no-footer table-responsive"></table>
                    </div>
                </div>
            </div>
        </div>
...
<script src="<?= autoVer(url: '/usr/registrations/registrations.js'); ?>"></script>
