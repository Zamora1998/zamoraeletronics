...
$client = [];
$orderParts = [];
$orderId = isset($orderId) ? (int)$orderId : 0;
...
<div class="edit-body">
    ...
    <!-- ==================== PARTES ==================== -->
    <div class="section-card" id="partes-section" style="<?= $isNew ? 'display:none' : '' ?>">
    ...
    <!-- ==================== FIRMA ==================== -->
    <div class="section-card" id="firma-section" style="<?= $isNew ? 'display:none' : '' ?>">
