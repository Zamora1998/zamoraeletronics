...
<div class="" id="table">
    <div class="row p-4 pb-0 align-items-center rounded-3 border shadow-lg">
        ...
        <table id="tableLabels" class="table table-striped nowrap"></table>
    </div>
</div>
<!-- Modal -->
<div class="modal fade" id="modalLabel" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" data-id="0">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="staticBackdropLabel"><?= $labels['lblEditLabel'] ?></h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-12 mb-3">
                        <input type="text" class="form-control form-control-sm" id="laName" name="laName" minlength="3" maxlength="25" required placeholder="<?= $labels['tblName'] ?>" title="<?= $labels['tblName'] ?>">
...
?>
                            <div class="tab-pane fade<?= $active ?>" id="laTab_<?= $lang['id'] ?>" role="tabpanel" aria-labelledby="tab_<?= $lang['id'] ?>">
                                <div class="form-floating mt-2">
                                    <textarea class="form-control" placeholder="<?= $labels['tblDescription'] ?>" id="description_<?= $lang['id'] ?>" name="laDescription[<?= $lang['id'] ?>]"></textarea>
...
?>
            ...
            <div class="modal-footer">
                <button type="button" id="labelSave" class="btn btn-sm btn-primary"><?= $labels['btnSave'] ?></button>
...
<?php require_once __ROOT__ . '/components/usr/usrfoot.php' ?>
    ...
    <script src="<?= autoVer('/adm/labels/labels.js'); ?>"></script>
</body>
